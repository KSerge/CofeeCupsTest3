...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.profile_image'
        db.add_column(u'hello_person', 'profile_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.profile_image'
        db.delete_column(u'hello_person', 'profile_image')
